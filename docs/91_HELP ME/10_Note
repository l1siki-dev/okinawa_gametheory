...
So you can see the edit history. I likely will fix small errors after the publication(v1.0).
...
I invented the CAE model (Percieved Capability model, Cp = Ap - Ep) while analyzing Okinawa.  
